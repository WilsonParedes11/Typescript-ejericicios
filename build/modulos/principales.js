...
const saludos_modulos_1 = require("./saludos_modulos");
const allGreetingFunctions = __importStar(require("./saludos_modulos")); // imports all exported components in the module
const saludos_utilidades_modulos_1 = require("./saludos_utilidades_modulos");
